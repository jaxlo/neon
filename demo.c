// This is a demo with the following pipeline
// - Quarter-Resolution Raytracing - Renders at 200x112 instead of 800x450 (16x fewer pixels)
// - RGB565 Conversion - Reduces color depth with Bayer dithering
